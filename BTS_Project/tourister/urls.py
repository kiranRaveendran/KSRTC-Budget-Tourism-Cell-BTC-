...
from .views import Signup,Login,Package_details,RateReviewAPI,Index,Navbar,Footer,Payment,Payment_Success,Package_BookingAPI,front_end_signup,front_end_login,Package_list,My_Booking,LogoutView
...
urlpatterns = [
    ...
    path('frontend_signup/', front_end_signup.as_view(), name='frontend signup'),
