...
from .views import Signup,Login,Package_details,RateReviewAPI,Index,Navbar,Footer,Payment,Payment_Success,Package_BookingAPI,front_end_signup,front_end_login
...
urlpatterns = [
    ...
    path('bookings/', Package_BookingAPI.as_view()),
